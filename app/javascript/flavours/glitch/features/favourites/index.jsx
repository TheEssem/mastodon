...
class Favourites extends ImmutablePureComponent {
  ...
  render () {
    ...
    const emptyMessage = <FormattedMessage id='empty_column.favourites' defaultMessage='No one has florped this post yet. When someone does, they will show up here.' />;
